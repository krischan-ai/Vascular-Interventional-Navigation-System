...
class NavigationStateResponse(BaseModel):
    ...
    contact_count: int = Field(default=0, description="Active tip contact records")
    wall_distance: float = Field(default=0.0, description="Min wall distance (m)")
    wall_penetration: float = Field(default=0.0, description="Max lumen-wall penetration (m)")
