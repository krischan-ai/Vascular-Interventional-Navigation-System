...
def _state_to_response(state, engine=None) -> NavigationStateResponse:
    ...
    return NavigationStateResponse(
        ...
        tip_contact_count=state.tip_contact_count,
        rod_contact_force=state.rod_contact_force,
        rod_contact_count=state.rod_contact_count,
        wall_contact_count=state.wall_contact_count,
        max_penetration=state.max_penetration,
        wall_penetration=state.wall_penetration,
        contact_impulse=state.contact_impulse,
        ...
        path_total_distance=state.path_total_distance,
        path_travelled_distance=state.path_travelled_distance,
